...
final class MapHelper {
   // static final LatLng LA_LOCATION = new LatLng(37.422, -122.084);

    /**
     * In kilometers.
     */
    private static final int EARTH_RADIUS = 150000;
    ...
    static PolygonOptions createPolygonWithCircle(Context context, LatLng center, int radius) {
        ...
        return new PolygonOptions()
                .fillColor(ContextCompat.getColor(context, R.color.colorlightblue))
